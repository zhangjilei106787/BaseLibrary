        ...
        Observable.create(new ObservableOnSubscribe<LiveData<List<StudentEntry>>>() {
            ...
            public void subscribe(ObservableEmitter<LiveData<List<StudentEntry>>> emitter) {
                try {
                    ...
                    AppRoomDataBase.getDataBaseInstance().getStudentDao().insert(studentEntry);
                    LiveData<List<StudentEntry>> listLiveData = AppRoomDataBase.getDataBaseInstance().getStudentDao().getAll1();
