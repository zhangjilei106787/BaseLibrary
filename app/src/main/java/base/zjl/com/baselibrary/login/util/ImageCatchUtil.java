...
import com.company.baselibrary.utils.glide.CustomGlideModule;
...
public class ImageCatchUtil {
    ...
    private final String ImageExternalCatchDir = MyApplication.getApplication().getExternalCacheDir()
    ...
    public String getCacheSize() {
        try {
            ...
            return getFormatSize(getFolderSize(new File(MyApplication.getApplication().getCacheDir()
                    + File.separator + CustomGlideModule.GLIDE_CARCH_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
        }
